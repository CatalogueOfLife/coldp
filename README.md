...
To avoid conflicts of naming scopes we strongly recommend to use the following scope names which are case insensitive:
 ...
 - clb: ChecklistBank identifier
    ...
    - A name usage with a compound key (datasetKey-nameUsageID): [clb:2019-14000204](https://www.checklistbank.org/dataset/2019/taxon/14000204): Puma concolor (id 14000204) in Mammal Species of the World
